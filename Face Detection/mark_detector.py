...
class FaceDetector:
    ...
    def __init__(self,
        ...
        """Initialization"""
        self.face_net = cv.dnn.readNetFromCaffe(dnn_proto_text, dnn_model)
    ...
    def get_faceboxes(self, image, threshold=0.5):
        ...
        self.face_net.setInput(cv.dnn.blobFromImage(
...
class MarkDetector:
    ...
    def draw_marks(image, marks, color=(255, 255, 255)):
        ...
        for mark in marks:
            cv.circle(image, (int(mark[0]), int(
                mark[1])), 1, color, -1, cv.LINE_AA)
